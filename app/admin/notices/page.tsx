...
export default async function AdminNoticesPage() {
  const [items, clients, views] = await Promise.all([listAllNotices(), listAccessibleClients(), listSavedViews('admin.notices')]);
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="tff-page-title">Notices</h1>
          <p className="tff-page-subtitle">Tax department correspondence across all clients.</p>
        </div>
