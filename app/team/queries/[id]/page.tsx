    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="space-y-3">
        {data.messages.length === 0 ? (
          <div className="rounded-xl border border-dashed border-zinc-200 bg-zinc-50/50 p-8 text-center text-sm text-zinc-500">No messages yet. Be the first to reply.</div>
